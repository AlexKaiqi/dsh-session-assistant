...
Session Assistant 持有会话上下文、产品 prompt、四个受控动作和 UI；`dsh-realtime-voice` 持有 Provider 与媒体传输；主 Agent 执行真正任务；可选 Personal Knowledge Base 持有知识投影、整理和提案授权。缺少可选知识插件时必须无损降级。
