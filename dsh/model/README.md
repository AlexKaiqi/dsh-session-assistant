...
The browser executes these UI-local operations. No filesystem, shell, network, Agent tool, or credential is exposed to the voice model. Realtime provider credentials remain in `dsh-realtime-voice`.
