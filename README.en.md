...
- The standby wake word is configurable. Only a finalized recognition result containing it starts Realtime; the complete original utterance, including the wake phrase, becomes the first user turn, so “Hello Assistant, continue the review” does not require repetition. Unmatched transcripts are not persisted.
