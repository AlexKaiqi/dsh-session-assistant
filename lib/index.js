import { c as OPENAI_REALTIME_VOICES, l as normalizeSettings, n as awarenessEventsInSession, o as DECLARED_SETTINGS_FIELDS, r as buildBoundedContext, s as DEFAULT_SETTINGS } from "./context-uH6iAF7z.js";
import { t as sessionAssistantRemoteDescriptors } from "./remote-contract-CZ7_xt7R.js";
...
//#endregion
//#region lib/types/model/product-knowledge.js
/**
* Canonical, human-readable product introduction.
* The operational assistant and voice tour both consume this exact file.
*/
const SESSION_ASSISTANT_INTRODUCTION_PATH = new URL("../INTRODUCTION.md", import.meta.url);
const SESSION_ASSISTANT_PRODUCT_KNOWLEDGE = readFileSync(SESSION_ASSISTANT_INTRODUCTION_PATH, "utf8").trim();
//#endregion
...
let SessionAssistantSettingsRemote = (() => {
	...
	return class SessionAssistantSettingsRemote extends _classSuper {
		static {
			...
			__esDecorate$1(this, null, _save_decorators, {
				kind: "method",
				name: "save",
				static: false,
				private: false,
			...
			__esDecorate$1(this, null, _context_decorators, {
				kind: "method",
				name: "context",
				static: false,
				private: false,
			...
			__esDecorate$1(this, null, _curate_decorators, {
				kind: "method",
				name: "curate",
				static: false,
				private: false,
		...
		scope = __runInitializers$1(this, _instanceExtraInitializers);
...
var ComposedVoicePipelineHost = class extends Service {
	...
	async synthesize(request, signal) {
		const result = await this.runtime().invoke("speech-synthesis", {
			routeId: request.routeId,
			operation: request.operation,
			request: {
				text: request.text,
	...
	runtime() {
		...
		if (runtime === void 0) throw new Error("taskPipelineRuntime is unavailable; install and enable dsh-multi-model-provider");
		return runtime;
	}
};
//#endregion
//#region lib/types/composed-voice-remote.js
...
let ComposedVoiceRemote = (() => {
	...
	return class ComposedVoiceRemote extends _classSuper {
		static {
			...
			__esDecorate(this, null, _synthesize_decorators, {
				kind: "method",
				name: "synthesize",
				static: false,
				private: false,
				access: {
					has: (obj) => "synthesize" in obj,
					get: (obj) => obj.synthesize
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			if (_metadata) Object.defineProperty(this, Symbol.metadata, {
		...
		async transcribe(request, signal) {
			return { text: (await this.pipeline.transcribe({
				routeId: request.routeId,
		...
		async synthesize(request, signal) {
			const result = await this.pipeline.synthesize({
				...
				text: request.text,
				...request.speaker === void 0 ? {} : { options: { speaker: request.speaker } }
			}, signal);
...
//#endregion
//#region lib/types/voice-pipeline.js
/**
...
function composedPipeline(input) {
	return {
		kind: "composed",
		asr: {
			routeId: input.asrRouteId,
			execution: input.asrExecution ?? "request-response"
		},
		language: input.language ?? { source: "current-session" },
		tts: {
			routeId: input.ttsRouteId,
			execution: input.ttsExecution ?? "request-response"
		}
	};
}
//#endregion
...
//#endregion
export { CONFIG_PATH, ComposedVoicePipelineHost, ComposedVoiceRemote, ComposedVoiceTurn, Config, DECLARED_SETTINGS_FIELDS, DEFAULT_SETTINGS, HELP, LEGACY_CONFIG_PATHS, OPENAI_REALTIME_VOICES, PROMPT, SESSION_ASSISTANT_PRODUCT_KNOWLEDGE, SESSION_ASSISTANT_TOOLS, SESSION_ASSISTANT_TOOL_OUTPUT, SETTINGS_NAMESPACE, SessionAssistantSettingsRemote, VERSION, apply, awarenessEventsInSession, buildBoundedContext, composedPipeline, inject, migrateLegacySettings, name, normalizeSettings, openAIProfileId, previewProfile, readLegacySettings, realtimeEditorInstructions, registerSessionAssistantSettings, sessionAssistantRemoteDescriptors, sessionProfile, sessionProfiles };
