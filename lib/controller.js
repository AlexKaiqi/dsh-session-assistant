import { a as finalAgentReplyAfter, i as countAssistantSteps, l as normalizeSettings, n as awarenessEventsInSession, o as DECLARED_SETTINGS_FIELDS, t as assistantReplyCursor } from "./context-BlIVglYH.js";
...
var VoiceController = class {
	...
	replyCursor;
	finalReplyWaiters = /* @__PURE__ */ new Set();
	...
	*/
	...
	submitRecognizedText(text, signal) {
		...
		return new Promise((resolve, reject) => {
			...
			const aborted = () => {
				this.finalReplyWaiters.delete(done);
...
function voiceAgentPreviewOptions(settings, routeId) {
	const openai = settings.recognitionProvider === "openai-realtime";
	const previewText = settings.recognitionLang === "zh-CN" ? "请简短欢迎我，并告诉我可以直接问你这个会话助手插件能做什么、有什么边界或推荐工作流，然后等我继续提问。" : "Welcome me briefly, explain that I can ask what the Session Assistant plugin can do, its boundaries, or recommended workflows, then wait for my questions.";
	return {
