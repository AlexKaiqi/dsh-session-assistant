...
const settingsSchema = z.object({
    recognitionProvider: z.enum(['browser', 'openai-realtime', 'doubao-realtime', 'composed']),
...
export function sessionAssistantRemoteDescriptors() {
    return [
        ...
        },
        {
            ...
            parameters: [{
                    name: 'request', wire: 'request', source: 'json',
                    codec: { mode: 'strict', typeSymbol: 'dsh-session-assistant#RemoteTranscribeRequest', schema: transcribeRequestSchema },
                }],
            cancellation: { parameter: 'signal' },
            result: { mode: 'strict', typeSymbol: 'dsh-session-assistant#RemoteTranscriptionResult', schema: transcriptionResultSchema },
        ...
        },
        {
            ...
            parameters: [{
                    name: 'request', wire: 'request', source: 'json',
                    codec: { mode: 'strict', typeSymbol: 'dsh-session-assistant#RemoteSynthesizeRequest', schema: synthesizeRequestSchema },
                }],
            cancellation: { parameter: 'signal' },
            result: { mode: 'strict', typeSymbol: 'dsh-session-assistant#RemoteSynthesisResult', schema: synthesisResultSchema },
