...
export class VoiceController {
    ...
    async stop() {
        ...
        if (handle !== undefined)
            await handle.end();
        if (!this.disposed)
            this.publish({ status: 'idle', phase: 'idle', transcript: '', error: undefined, errorCode: undefined, handoff: undefined, submitNotice: undefined, question: undefined, agentReply: undefined });
    }
    async dispose() {
        if (this.disposed)
            return;
