...
export const zh = {
    ...
    readRate: '朗读语速',
    voicePreview: '助手音色试听',
    readAloudPreview: '回复朗读试听',
    playRealtimePreview: '试听助手音色',
    stopRealtimePreview: '停止助手试听',
    realtimePreviewUsingCurrent: '播放当前 Realtime 模型与音色；可能消耗少量 Provider 额度',
    realtimePreviewConnecting: '正在连接所选 Realtime 音色…',
    realtimePreviewPlaying: '正在播放所选助手音色…',
    realtimePreviewUnavailable: '所选 Realtime 音色当前不可试听',
    realtimePreviewClosed: '试听连接在播放前结束',
    realtimePreviewTimeout: '试听超时',
    playPreview: '播放试听',
    stopPreview: '停止试听',
    previewUsingCurrent: '使用当前未保存的音色和语速',
    previewPlaying: '正在播放当前音色与语速…',
    previewComplete: '试听完成',
    previewUnsupported: '当前浏览器不支持语音试听',
    previewFailed: '试听失败：',
...
export const en = {
    ...
    readAloudPreview: 'Reply read-aloud preview',
    playRealtimePreview: 'Preview assistant voice',
    stopRealtimePreview: 'Stop assistant preview',
    realtimePreviewUsingCurrent: 'Plays the current Realtime model and voice; may use a small amount of Provider quota',
    realtimePreviewConnecting: 'Connecting to the selected Realtime voice…',
    realtimePreviewPlaying: 'Playing the selected assistant voice…',
    realtimePreviewUnavailable: 'The selected Realtime voice cannot be previewed',
    realtimePreviewClosed: 'The preview connection closed before playback',
    realtimePreviewTimeout: 'Voice preview timed out',
    playPreview: 'Play preview',
    stopPreview: 'Stop preview',
    previewUsingCurrent: 'Uses the current unsaved voice and speed',
    previewPlaying: 'Playing the current voice and speed…',
    previewComplete: 'Preview complete',
    previewUnsupported: 'Voice preview is unavailable in this browser',
