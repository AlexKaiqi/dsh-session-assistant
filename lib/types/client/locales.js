...
export const zh = {
    ...
    realtimePreviewUsingCurrent: '点击后助手会先用所选 Realtime 音色打招呼，你可以直接继续和它语音对话；可能消耗少量 Provider 额度',
    realtimePreviewConnecting: '正在连接所选 Realtime 音色…',
    realtimePreviewFinished: '试听完成，可再次播放',
...
export const en = {
    ...
    realtimePreviewUsingCurrent: 'The assistant will greet you with the selected Realtime voice, then stay available for a spoken conversation; may use a small amount of Provider quota',
    realtimePreviewConnecting: 'Connecting to the selected Realtime voice…',
    realtimePreviewFinished: 'Preview finished; play again anytime',
